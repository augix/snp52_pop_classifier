...
config.name = 'longformer_contig2048_d512_cd16_cs32'
...
config.ckpt_path = f'results/{config.name}/ckpt/pretrain0.94975.ckpt'  # Path of specific checkpoint to load, default is last.ckpt
