...
config = Namespace(
    ...
    bs_train = 80,                      # Reduced batch size for training to save memory
    bs_val = 160,                        # Reduced batch size for validation to save memory
    ...
    # model 
    model_py = 'model/cnn.py',  # Path to model module
    ...
    log_every_n_steps = 16,            # Log metrics every N steps
