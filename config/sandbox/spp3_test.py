...
config = Namespace(
    ...
    # == 1kG data ==
    fn_emb_test   = '../task48b_prepare_1kG_data/res_s3/emb.pt',
    fn_pairs_test = '../task48b_prepare_1kG_data/res_s2/pairs.tsv',
    ...
    # fn_emb_test     = '../task48c_prepare_kinship_data_ped-sim/res_s3_ped-sim_4_trees_CHS/emb.pt',
    # fn_pairs_test   = '../task48c_prepare_kinship_data_ped-sim/res_s4_ped-sim_4_trees_CHS/pairs.tsv',
    ...
    # fn_emb_test     = '../task48c_prepare_kinship_data_ped-sim/res_s3_val_4_trees/emb.pt',
    # fn_pairs_test   = '../task48c_prepare_kinship_data_ped-sim/res_s4_val_4_trees/pairs.tsv',
    ...
    # fn_emb_test     = '../task48d_prepare_ped-sim_trees_4train_1val/res_s3_small_ped-sim_val_1_tree/emb.pt',
    # fn_pairs_test   = '../task48d_prepare_ped-sim_trees_4train_1val/res_s4_small_ped-sim_val_1_trees/pairs.tsv',
    ...
    bs_train = 16,                      # batch size for training
    bs_val = 16,                        # batch size for validation
    bs_test = 128,                        # batch size for test
    ...
    # compression
    bin_sizes = [2048, 1024, 512, 256, 128, 64], # correspond to 3, 6, 12, 24, 48 contigs per bin
    kernel_size = 8,
    stride = 4,
    cs = 16,
    cd = 16,
...
config.ckpt_path = f'results/spp3/ckpt/epoch=26-val_acc=0.58618.ckpt'  # Path to specific checkpoint to load (set at runtime)
