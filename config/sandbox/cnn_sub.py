...
config = Namespace(
    ...
    kinship_values = [0,1,2,3,4,5],
    n_output_values = 6,               # Number of possible output values: 0-19 kinship
    ...
    bs_val = 64,                        # Reduced batch size for validation to save memory
    n_id = 3000,                        # Number of contig IDs, 2935 for all contigs in a genome
    mask_fraction = 0.0,               # Fraction of masking

    # model 
    model_py = 'model/cnn_sub.py',  # Path to model module
    ...
    val_check_interval = 0.25,          # Fraction of training epoch after which to run validation
