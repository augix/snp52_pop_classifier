...
config.name = f'global_encode_local_decode_contig{config.contig_len}_mask{config.mask_frac}'
config.data_py = 'data/data_contigs.py'
config.model_py = 'model/global_encode_local_decode.py'
...
config.wandb = {
    ...
    'group': 'global encode local decode',             # Group name for the run
}
