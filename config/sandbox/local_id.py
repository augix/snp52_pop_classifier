...
config.name = f'local_id_compress_contig{config.contig_len}_mask{config.mask_frac}'
config.data_py = 'data/data_contigs_local_id.py'
config.model_py = 'model/deepseek_with_local_id.py'
...
config.bs_train = 60
config.bs_val = 60
config.val_check_interval = 0.02
